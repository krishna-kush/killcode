#!/bin/bash
# Test script: Upload base binary → Wait for merge → Download merged binary → Execute
# This tests the complete flow with the new architecture where overload just verifies in a loop
